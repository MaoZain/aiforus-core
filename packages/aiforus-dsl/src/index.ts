/**
 * @aiforus/dsl — the pure, dependency-free contract keystone for the MAIC SDK family.
 *
 * Dependency arrows (kept acyclic):
 *   @aiforus/dsl       -> (nothing)
 *   @aiforus/vue-renderer -> @aiforus/dsl
 *   AIForUs application producers -> @aiforus/dsl
 *
 ...
 * under `@aiforus/dsl/schema/*`; the pure `validate*` / `normalize*` functions
